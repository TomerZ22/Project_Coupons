...
import bl.Facades.CouponExistsException;
...
public class Test {
    public static void main(String[] args) throws CouponNotInStock, LoginErrorException, SQLException, CouponExpires, CouponExistsException {
